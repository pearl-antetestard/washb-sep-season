...
glm_int_log <- glm(diar7df ~ monsoon.f + Arms + monsoon.f*Arms,
...
# modeling a log binomial fit with interaction
glm_noint_log <- glm(diar7df ~ monsoon.f + Arms,
            family = binomial(link="log"),
            data = df_analysis_svy12)
...
ggsave(plot_prev_composite, file = here::here("2-initial-analysis", "output",
                      "plot_effectmodmonsoon_glm.pdf"), height=5,width=2)

ggsave(plot_prev_composite, file = here::here("2-initial-analysis", "output",
                      "plot_effectmodmonsoon_glm.png"), height=5,width=2)

#ggsave(plot_prev_composite, file = here::here("2-initial-analysis", "output",
                     # "plot_effectmodmonsoon_2.png"), height=5,width=2)

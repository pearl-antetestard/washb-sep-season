...
# Diarrhea prevalence
gam_plot_prev_rainy <- plot_smooths(model = mod_gam_1, series = wealth_rank, 
                         comparison = Arms) +
                 ...
                 labs(x = "Wealth rank based on the wealth index score",
                      y = "Diarrhea Prevalence (%) \nduring monsoon", title = "A. Diarrhea Prevalence") +
                    #title = "gam") +
...
plot_ratio_rainy <- ggplot(gam_ratio, aes(wealth_rank, exp(difference)#, group=group
                     )) +
              ...
              scale_y_continuous(breaks=c(1,1.5,2,3),trans = "log") +
              labs(x = "Wealth rank based on the wealth index score",
              y = "Prevalence Ratio (PR) \nduring monsoon", title = "B. Prevalence Ratio") +
...
plot_diff_rainy <- ggplot(gam_diff, aes(wealth_rank, difference#, group=group
                                  )) +
             ...
             scale_y_continuous(breaks=seq(-0.004,0.10,by=0.02), limits = c(-0.004,0.10),
                                    labels =  sprintf("%1.0f",seq(-0.004,0.10,by=0.02)*100)) +
             ...
             #labs(colour = "Significant", fill = "Significant") +
             labs(x = "Wealth rank based on the wealth index score",
             y = "Prevalence Difference (PD,%) \nduring monsoon", title = "C. Prevalence Difference") +
...
plot_prev_composite_rainy <- plot_grid(gam_plot_prev_rainy, plot_ratio_rainy, plot_diff_rainy, 
                               nrow=3, align = "h") 
plot_prev_composite_rainy
...
ggsave(plot_prev_composite, file = here::here("2-initial-analysis", "output",
                      "plot_effectmodsep_gam_rainy.png"), height=8,width=5)

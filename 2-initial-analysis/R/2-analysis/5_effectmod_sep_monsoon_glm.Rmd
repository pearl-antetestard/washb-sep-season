...
glm_int_log <- glm(diar7df ~  Arms + wealth_tertilef + monsoon.f +
...
glm_noint_log <- glm(diar7df ~ Arms + wealth_tertilef + monsoon.f +
                       wealth_tertilef*Arms + monsoon.f*Arms,
            family = binomial(link="log"),
            data = df_analysis_svy12)
...
ggsave(plot_prev_composite, file = here::here("2-initial-analysis", "output",
                      "plot_effectmodsepmonsoon_glm.pdf"), height=6,width=3)
